...
| SEC-2 | MEDIUM | overview §4.5 vs DETAILED §4.5 / kzocr/security/egress.py | 概览写 `from kzocr.engines.egress import validate_url`;正确路径为 `kzocr.security.egress`(DETAILED 已更正并标注"修复架构 N3";代码亦在 `security/`)。 | 修正概览文档导入路径。 |
